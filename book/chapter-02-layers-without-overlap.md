...
The test for solution architecture is one that will appear throughout this book because it is the most reliable diagnostic in the discipline: **can delivery begin immediately, without further clarification?** If the answer is yes — if a delivery team can read the architecture and know exactly what to build without asking another question — the decision has been made. If the answer is no, the artefact is analysis, not architecture. It describes the territory without choosing the path.
